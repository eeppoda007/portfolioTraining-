...
var shopItemsArray: [String] = ["milk", "cheese", "water", "soda"]
var shopItemsDictionary = ["milk" : 5.99, "cheese" : 2.99, "water" : 1.99, "soda" : 1.19 ]
// 2
shopItemsArray.contains("butter")
// 3
shopItemsArray.insert("butter", at: 0)
// 4
var selectedItem = shopItemsArray[2]
// 5
var selectedItemPrice = shopItemsDictionary[selectedItem]
// 6
var fullArmorSet: Set = ["butter milk","tee biscuts","water mellon "]
var currentArmorSet: Set = ["butter milk","tee biscuts","dog treat","spunge bath"]

// 7
fullArmorSet.subtract(currentArmorSet)
// 8
var armorPieceTuple = (name: "water",cost: 5,canEquip: false)
