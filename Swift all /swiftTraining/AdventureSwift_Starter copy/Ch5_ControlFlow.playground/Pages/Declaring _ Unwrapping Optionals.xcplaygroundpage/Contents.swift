 ...
 */
// Creating optionals
var itemGathered: String? = "Pixkaxe"
...
if let item = itemGathered {
    ...
    if let bonus = hpBonus {
        print(bonus)
       // nexsted condition here
    }
}else {
...
if let expNeeded = expToNextLevel, let bonus = hpBonus{
    print("You need \(expNeeded) Exp to reach the next level, and recieve \(bonus) HP!")
} else{
