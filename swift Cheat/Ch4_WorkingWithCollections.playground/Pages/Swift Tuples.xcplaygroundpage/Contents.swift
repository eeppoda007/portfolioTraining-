...
uppercutAttack.0
// Naming tuple values
var planetSmashAttCK = (moveName: "Planet Smash",damage: 25,isRechargeable: true)
planetSmashAttCK.damage
planetSmashAttCK.1

// Naming values with type annotation
var shieldDtompAttack: (name: String, dm: Int, canRecharge: Bool)
shieldDtompAttack = ("Shield Stomp", 35, false)
shieldDtompAttack.canRecharge
shieldDtompAttack.2
